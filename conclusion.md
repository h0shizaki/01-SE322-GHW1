...
- **Problem 10**: Creating new threads and destroying threads takes a lot of ([s03-024](./memo/s03-024.md))
	- Thread pool: allocate pool of reusable threads to execute tasks by supervisor. ([s03-024](./memo/s03-024.md))
- **Problem 11**: Data corruption ([s05-046](./memo/s05-046.md))
	- Use thread-safe methods. ([s05-046](./memo/s05-046.md))
- **Problem 12**: Data corruption when the same data gets modified at the same time ([s04-024](./memo/s04-024.md))
	- Optimistic concurrency via concurrency tokens: assuming that conflict is rare, but will fail the data modification if the data is changed since it was queried. ([s04-024](./memo/s04-024.md))
	- Isolation levels: making sure that a transaction sees data in the database as it was when the transaction started. the transaction can complete in two ways,. ([s04-024](./memo/s04-024.md))
- **Problem 13**: Data versioning issue ([s05-003](./memo/s05-003.md))
...
- **Problem 14**: Deadlock ([s01-003](./memo/s01-003.md), [s01-046](./memo/s01-046.md), [s02-025](./memo/s02-025.md), [s03-003](./memo/s03-003.md), [s03-046](./memo/s03-046.md), [s04-047](./memo/s04-047.md), [s05-042](./memo/s05-042.md))
...
- **Problem 15**: Dealing the need for programs to run smaller components simultaneously, such as handling multiple requests in a web server ([s02-042](./memo/s02-042.md))
...
- **Problem 16**: Dining philosopher ([s03-047](./memo/s03-047.md))
...
- **Problem 17**: Dirty read ([s01-047](./memo/s01-047.md), [s02-009](./memo/s02-009.md), [s02-046](./memo/s02-046.md), [s03-009](./memo/s03-009.md), [s05-025](./memo/s05-025.md), [s05-047](./memo/s05-047.md))
...
- **Problem 18**: Eternal lock resource ([s04-003](./memo/s04-003.md))
	- Adding timeout to the lock. ([s04-003](./memo/s04-003.md))
- **Problem 19**: Execution of a program for communicating data with event loop ([s04-042](./memo/s04-042.md))
	- Some time-consuming operations are delegated. ([s04-042](./memo/s04-042.md))
- **Problem 20**: Fuzzy read ([s01-032](./memo/s01-032.md))
...
- **Problem 21**: Goroutines run in order rather than simultaneously ([s02-042](./memo/s02-042.md))
	- Add some delay to the function using time.sleep and rand.intn:. ([s02-042](./memo/s02-042.md))
- **Problem 22**: Heisenbug ([s01-042](./memo/s01-042.md))
	- Try to look at it with 'println' or 'debugger'. ([s01-042](./memo/s01-042.md))
- **Problem 23**: Inconsistent read ([s03-003](./memo/s03-003.md))
	- Controlling access. ([s03-003](./memo/s03-003.md))
	- Temporal reading. ([s03-003](./memo/s03-003.md))
- **Problem 24**: Inconsistent retrieval ([s04-025](./memo/s04-025.md))
- **Problem 25**: Incorrect summary ([s02-047](./memo/s02-047.md), [s03-009](./memo/s03-009.md))
...
- **Problem 26**: Incorrect update ([s03-009](./memo/s03-009.md))
...
- **Problem 27**: It is necessary to protect multiple applications from each other ([s05-042](./memo/s05-042.md))
- **Problem 28**: It is necessary to use extra techniques to coordinate several application ([s05-042](./memo/s05-042.md))
- **Problem 29**: Limits of concurrency gain ([s05-033](./memo/s05-033.md))
...
- **Problem 30**: Locating the programming error ([s05-042](./memo/s05-042.md))
- **Problem 31**: Locking read ([s01-032](./memo/s01-032.md))
...
- **Problem 32**: Locking the channel ([s05-042](./memo/s05-042.md))
- **Problem 33**: Loss of synchronization ([s04-046](./memo/s04-046.md))
	- Pass synchronized resources by reference. ([s04-046](./memo/s04-046.md))
- **Problem 34**: Lost update ([s01-047](./memo/s01-047.md), [s02-003](./memo/s02-003.md), [s02-009](./memo/s02-009.md), [s02-046](./memo/s02-046.md), [s02-047](./memo/s02-047.md), [s03-003](./memo/s03-003.md), [s04-025](./memo/s04-025.md), [s05-025](./memo/s05-025.md), [s05-047](./memo/s05-047.md))
	- Currently committed semantics. ([s02-003](./memo/s02-003.md))
...
- **Problem 43**: Object executes a certain code when it is in an incomplete or inappropriate state ([s01-024](./memo/s01-024.md))
	- Balking pattern: certain code only executes only if the object is in particular state. ([s01-024](./memo/s01-024.md))
- **Problem 44**: Optimal allocation of resource ([s05-042](./memo/s05-042.md))
- **Problem 45**: Over-parallelization ([s05-046](./memo/s05-046.md))
	- Evaluate if sub-problems are worth parallelizing considering the overhead. ([s05-046](./memo/s05-046.md))
- **Problem 46**: Overhead when acquiring a lock ([s05-024](./memo/s05-024.md))
	- Double-checked locking: test if the locking is required before actually locking. ([s05-024](./memo/s05-024.md))
- **Problem 47**: Parallelism may come out slower ([s05-046](./memo/s05-046.md))
...
- **Problem 48**: Phantom read ([s01-047](./memo/s01-047.md), [s02-003](./memo/s02-003.md), [s02-047](./memo/s02-047.md), [s05-025](./memo/s05-025.md), [s05-047](./memo/s05-047.md))
	- Currently committed semantics. ([s02-003](./memo/s02-003.md))
	- Set the thread isolation level. ([s02-003](./memo/s02-003.md))
	- Concurrency control protocols  ensure consistency , atomicity, isolation, and serializability of concurrent transactions in a database. the concurrency control protocol  can be any of the following type. ([s05-047](./memo/s05-047.md))
- **Problem 49**: Priority inversion ([s02-025](./memo/s02-025.md), [s02-032](./memo/s02-032.md))
...
- **Problem 50**: Producer consumer ([s03-047](./memo/s03-047.md))
...
- **Problem 51**: Race condition ([s01-046](./memo/s01-046.md), [s02-025](./memo/s02-025.md), [s03-046](./memo/s03-046.md), [s04-046](./memo/s04-046.md), [s04-047](./memo/s04-047.md), [s05-042](./memo/s05-042.md))
...
- **Problem 52**: Resource contention ([s05-032](./memo/s05-032.md))
...
- **Problem 53**: Shared state & race condition ([s05-046](./memo/s05-046.md))
...
- **Problem 54**: Sharing global resource ([s05-042](./memo/s05-042.md))
- **Problem 55**: Spawning a fiber and waiting for it to complete ([s04-042](./memo/s04-042.md))
...
- **Problem 56**: Starvation ([s01-046](./memo/s01-046.md), [s02-025](./memo/s02-025.md), [s05-042](./memo/s05-042.md))
...
- **Problem 57**: Synchronization issue ([s04-047](./memo/s04-047.md))
...
- **Problem 58**: Temporary update ([s02-047](./memo/s02-047.md))
...
- **Problem 59**: The complex coordination of authentication protocols in a network management application ([s04-033](./memo/s04-033.md))
	- Create a row for each mac address and protocol combination. ([s04-033](./memo/s04-033.md))
- **Problem 60**: The complexity and challenges associated with concurrent programming in java ([s01-033](./memo/s01-033.md))
	- In java8,they improvements and simplifications to make it easier to do concurrency. ([s01-033](./memo/s01-033.md))
- **Problem 61**: The complexity and difficulty associated with concurrent programming ([s02-033](./memo/s02-033.md))
...
- **Problem 62**: The concurrency in software and systems engineering greatly increases complexity, make it to nondeterministic behavior and various type of concurrency defect ([s03-033](./memo/s03-033.md))
...
- **Problem 63**: The confusion between the terms "concurrency" and "parallelism" ([s04-042](./memo/s04-042.md))
	- Acknowledge the definitions of "concurrency" and "parallelism". ([s04-042](./memo/s04-042.md))
- **Problem 64**: The difficulty and error-proneness of concurrent programming ([s04-009](./memo/s04-009.md))
	- Plan and design in advance: proper planning and designing of a concurrent system. ([s04-009](./memo/s04-009.md))
- **Problem 65**: The interference between concurrent features and object-oriented features in a programming language ([s05-009](./memo/s05-009.md))
...
- **Problem 66**: The need to maintain data unique to a thread ([s02-024](./memo/s02-024.md))
	- Thread-local storage. ([s02-024](./memo/s02-024.md))
- **Problem 67**: The occurrence of race conditions in concurrency ([s04-033](./memo/s04-033.md))
...
- **Problem 68**: The potential loss of information or synchronization issues when using buffered channel ([s04-042](./memo/s04-042.md))
	- Ensuring that the receiving fiber is ready to consume values before the sending fiber proceeds. ([s04-042](./memo/s04-042.md))
- **Problem 69**: Thread hanging ([s04-046](./memo/s04-046.md))
...
- **Problem 70**: Uncommitted data ([s04-025](./memo/s04-025.md))
- **Problem 71**: Unrepeatable read ([s01-047](./memo/s01-047.md), [s02-046](./memo/s02-046.md), [s02-047](./memo/s02-047.md), [s05-047](./memo/s05-047.md))
	...
	- Implement validation protocol. ([s02-046](./memo/s02-046.md))
	- Concurrency control protocols  ensure consistency , atomicity, isolation, and serializability of concurrent transactions in a database. the concurrency control protocol  can be any of the following type. ([s05-047](./memo/s05-047.md))
- **Problem 72**: Users expect their systems to perform multiple tasks simultaneously such as downloading file ([s03-042](./memo/s03-042.md))
...
- **Problem 73**: Visibility ([s05-033](./memo/s05-033.md))
...
- **Problem 74**: When running code, return order will be difference time ([s01-025](./memo/s01-025.md))
...
- **Problem 75**: When running the code, it is possible to encounter delays in generating output, such as when users type rapidly. it may lead to a perceived lack of responsiveness from the application ([s01-025](./memo/s01-025.md))
...
- If the tasks are parallelable ([s03-024](./memo/s03-024.md))
- If the tasks at hand would be short lived ([s03-024](./memo/s03-024.md))
...
- Storage available to store data for each thread ([s02-024](./memo/s02-024.md))
...
- The context of the transaction ([s04-024](./memo/s04-024.md))
...
- The object's state ([s01-024](./memo/s01-024.md))
...
- The solution can be anti-pattern to some language/hardware ([s05-024](./memo/s05-024.md))
- The time that the object will remain in that state ([s01-024](./memo/s01-024.md))
