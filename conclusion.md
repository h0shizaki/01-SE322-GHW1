...
- **Problem 15**: Dirty read ([s01-047](./memo/s01-047.md), [s02-009](./memo/s02-009.md), [s02-046](./memo/s02-046.md), [s03-009](./memo/s03-009.md), [s05-025](./memo/s05-025.md), [s05-047](./memo/s05-047.md))
...
- **Problem 16**: Eternal lock resource ([s04-003](./memo/s04-003.md))
	- Adding timeout to the lock. ([s04-003](./memo/s04-003.md))
- **Problem 17**: Execution of a program for communicating data with event loop ([s04-042](./memo/s04-042.md))
	- Some time-consuming operations are delegated. ([s04-042](./memo/s04-042.md))
- **Problem 18**: Fuzzy read ([s01-032](./memo/s01-032.md))
...
- **Problem 19**: Goroutines run in order rather than simultaneously ([s02-042](./memo/s02-042.md))
	- Add some delay to the function using time.sleep and rand.intn:. ([s02-042](./memo/s02-042.md))
- **Problem 20**: Heisenbug ([s01-042](./memo/s01-042.md))
	- Try to look at it with 'println' or 'debugger'. ([s01-042](./memo/s01-042.md))
- **Problem 21**: Inconsistent read ([s03-003](./memo/s03-003.md))
	- Controlling access. ([s03-003](./memo/s03-003.md))
	- Temporal reading. ([s03-003](./memo/s03-003.md))
- **Problem 22**: Inconsistent retrieval ([s04-025](./memo/s04-025.md))
- **Problem 23**: Incorrect summary ([s02-047](./memo/s02-047.md), [s03-009](./memo/s03-009.md))
...
- **Problem 24**: Incorrect update ([s03-009](./memo/s03-009.md))
...
- **Problem 25**: It is necessary to protect multiple applications from each other ([s05-042](./memo/s05-042.md))
- **Problem 26**: It is necessary to use extra techniques to coordinate several application ([s05-042](./memo/s05-042.md))
- **Problem 27**: Limits of concurrency gain ([s05-033](./memo/s05-033.md))
...
- **Problem 28**: Locating the programming error ([s05-042](./memo/s05-042.md))
- **Problem 29**: Locking read ([s01-032](./memo/s01-032.md))
...
- **Problem 30**: Locking the channel ([s05-042](./memo/s05-042.md))
- **Problem 31**: Loss of synchronization ([s04-046](./memo/s04-046.md))
	- Pass synchronized resources by reference. ([s04-046](./memo/s04-046.md))
- **Problem 32**: Lost update ([s01-047](./memo/s01-047.md), [s02-003](./memo/s02-003.md), [s02-009](./memo/s02-009.md), [s02-046](./memo/s02-046.md), [s02-047](./memo/s02-047.md), [s03-003](./memo/s03-003.md), [s04-025](./memo/s04-025.md), [s05-025](./memo/s05-025.md), [s05-047](./memo/s05-047.md))
	- Currently committed semantics. ([s02-003](./memo/s02-003.md))
	...
	- Time-stamp concurrency control protocol. ([s05-047](./memo/s05-047.md))
	- Validation based concurrency control protocol. ([s05-047](./memo/s05-047.md))
- **Problem 33**: Lost updated when two users attempt to update the same piece of data at the same time ([s03-025](./memo/s03-025.md))
...
- **Problem 34**: Memory consistency ([s03-046](./memo/s03-046.md))
...
- **Problem 35**: Misunderstanding of race condition ([s01-009](./memo/s01-009.md))
...
- **Problem 36**: Misusing lock ([s03-046](./memo/s03-046.md))
	- Use resource locks appropriately. ([s03-046](./memo/s03-046.md))
- **Problem 37**: Misusing of wait ([s04-046](./memo/s04-046.md))
	- Study how waits and workgroup waits work in your language. ([s04-046](./memo/s04-046.md))
- **Problem 38**: Mongodb doesn't guarantee acid compliance ([s04-003](./memo/s04-003.md))
...
- **Problem 39**: Non-atomic ([s05-042](./memo/s05-042.md))
- **Problem 40**: Non-repeatable data ([s02-003](./memo/s02-003.md))
	- Set the thread isolation level. ([s02-003](./memo/s02-003.md))
- **Problem 41**: Optimal allocation of resource ([s05-042](./memo/s05-042.md))
- **Problem 42**: Over-parallelization ([s05-046](./memo/s05-046.md))
	- Evaluate if sub-problems are worth parallelizing considering the overhead. ([s05-046](./memo/s05-046.md))
- **Problem 43**: Parallelism may come out slower ([s05-046](./memo/s05-046.md))
...
- **Problem 44**: Phantom read ([s01-047](./memo/s01-047.md), [s02-003](./memo/s02-003.md), [s02-047](./memo/s02-047.md), [s05-025](./memo/s05-025.md), [s05-047](./memo/s05-047.md))
	- Currently committed semantics. ([s02-003](./memo/s02-003.md))
	- Set the thread isolation level. ([s02-003](./memo/s02-003.md))
	- Concurrency control protocols  ensure consistency , atomicity, isolation, and serializability of concurrent transactions in a database. the concurrency control protocol  can be any of the following type. ([s05-047](./memo/s05-047.md))
	- Lock based concurrency control protocol. ([s05-047](./memo/s05-047.md))
	- Time-stamp concurrency control protocol. ([s05-047](./memo/s05-047.md))
	- Validation based concurrency control protocol. ([s05-047](./memo/s05-047.md))
- **Problem 45**: Priority inversion ([s02-025](./memo/s02-025.md), [s02-032](./memo/s02-032.md))
...
- **Problem 46**: Producer consumer ([s03-047](./memo/s03-047.md))
...
- **Problem 47**: Race condition ([s01-046](./memo/s01-046.md), [s02-025](./memo/s02-025.md), [s03-046](./memo/s03-046.md), [s04-046](./memo/s04-046.md), [s04-047](./memo/s04-047.md), [s05-042](./memo/s05-042.md))
...
- **Problem 48**: Resource contention ([s05-032](./memo/s05-032.md))
...
- **Problem 49**: Shared state & race condition ([s05-046](./memo/s05-046.md))
...
- **Problem 50**: Sharing global resource ([s05-042](./memo/s05-042.md))
- **Problem 51**: Spawning a fiber and waiting for it to complete ([s04-042](./memo/s04-042.md))
...
- **Problem 52**: Starvation ([s01-046](./memo/s01-046.md), [s02-025](./memo/s02-025.md), [s05-042](./memo/s05-042.md))
...
- **Problem 53**: Synchronization issue ([s04-047](./memo/s04-047.md))
...
- **Problem 54**: Temporary update ([s02-047](./memo/s02-047.md))
...
- **Problem 55**: The complex coordination of authentication protocols in a network management application ([s04-033](./memo/s04-033.md))
	- Create a row for each mac address and protocol combination. ([s04-033](./memo/s04-033.md))
- **Problem 56**: The complexity and challenges associated with concurrent programming in java ([s01-033](./memo/s01-033.md))
	- In java8,they improvements and simplifications to make it easier to do concurrency. ([s01-033](./memo/s01-033.md))
- **Problem 57**: The complexity and difficulty associated with concurrent programming ([s02-033](./memo/s02-033.md))
...
- **Problem 58**: The concurrency in software and systems engineering greatly increases complexity, make it to nondeterministic behavior and various type of concurrency defect ([s03-033](./memo/s03-033.md))
...
- **Problem 59**: The confusion between the terms "concurrency" and "parallelism" ([s04-042](./memo/s04-042.md))
	- Acknowledge the definitions of "concurrency" and "parallelism". ([s04-042](./memo/s04-042.md))
- **Problem 60**: The difficulty and error-proneness of concurrent programming ([s04-009](./memo/s04-009.md))
	- Plan and design in advance: proper planning and designing of a concurrent system. ([s04-009](./memo/s04-009.md))
- **Problem 61**: The interference between concurrent features and object-oriented features in a programming language ([s05-009](./memo/s05-009.md))
...
- **Problem 62**: The occurrence of race conditions in concurrency ([s04-033](./memo/s04-033.md))
...
- **Problem 63**: The potential loss of information or synchronization issues when using buffered channel ([s04-042](./memo/s04-042.md))
	- Ensuring that the receiving fiber is ready to consume values before the sending fiber proceeds. ([s04-042](./memo/s04-042.md))
- **Problem 64**: Thread hanging ([s04-046](./memo/s04-046.md))
...
- **Problem 65**: Uncommitted data ([s04-025](./memo/s04-025.md))
- **Problem 66**: Unrepeatable read ([s01-047](./memo/s01-047.md), [s02-046](./memo/s02-046.md), [s02-047](./memo/s02-047.md), [s05-047](./memo/s05-047.md))
	...
	- Time-stamp concurrency control protocol. ([s05-047](./memo/s05-047.md))
	- Validation based concurrency control protocol. ([s05-047](./memo/s05-047.md))
- **Problem 67**: Users expect their systems to perform multiple tasks simultaneously such as downloading file ([s03-042](./memo/s03-042.md))
...
- **Problem 68**: Visibility ([s05-033](./memo/s05-033.md))
...
- **Problem 69**: When running code, return order will be difference time ([s01-025](./memo/s01-025.md))
...
- **Problem 70**: When running the code, it is possible to encounter delays in generating output, such as when users type rapidly. it may lead to a perceived lack of responsiveness from the application ([s01-025](./memo/s01-025.md))
